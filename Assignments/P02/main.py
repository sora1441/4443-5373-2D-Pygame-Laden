...
class Game:
    ...
    def update(self):
        ...
        for pow in pow_hits:
            if pow.type == 'boost':
                ...
                self.needed_to_jump +=1
                self.items_collected +=1
                if self.needed_to_jump == 3:
    ...
    def draw(self):
        ...
        self.draw_text(str(self.items_collected), 22, WHITE, WIDTH / 2, 15)
    ...
    def show_start_screen(self):
        ...
        self.draw_text("Get 3 medals to jump and 15 to win!", 22, BLACK, WIDTH / 2, 15)
        pygame.display.flip()
        self.wait_for_key()
        pygame.mixer.music.fadeout(500)
    ...
    def show_go_screen(self):
        ...
        if self.items_collected !=10:
            ...
            self.draw_text("Score: " + str(self.items_collected), 22, WHITE, WIDTH / 2, HEIGHT / 2)
            self.draw_text("Press a key to play again", 22, WHITE, WIDTH / 2, HEIGHT * 3 / 4)
        if self.items_collected==10:
            self.draw_text("Congradulations!!", 50, WHITE, WIDTH / 2, HEIGHT /4)
            self.draw_text("Press a key to play again", 22, WHITE, WIDTH / 2, HEIGHT * 3 / 4)
            self.items_collected=0
            self.jump_no =0
        pygame.display.flip()
    ...
    def show_splash(self):
        waiting = True
        while waiting:
            self.screen.blit("splash.png", (0,0))
            for event in pygame.event.get():
                if event.type == pygame.KEYUP:
                    waiting = False
